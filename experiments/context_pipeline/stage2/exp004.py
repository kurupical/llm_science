...
class BertConfig:
    ...
    use_peft: bool = False
    metric_for_best_model: str = "eval_eval_loss"
...
def main(config: BertConfig):
    try:
        ...
        if config.debug:
            df = df.iloc[:20]
        df_test = pd.read_parquet(f"{config.dataset_dir}/searched_index_test.parquet")
...
if __name__ == "__main__":
    ...
    #         model_name=model_name,
    #         dataset_dir="output/context_pipeline/stage1/exp006.py/20230914064251_multi-qa-mpnet-base-dot-v1_wikiall_without_sep_targetprompt_and_choice_without_sep_token_length200_stride100_all",
    #         freeze_layers=0,
    #         max_length=256,
    #         num_context=1,
    #     )
    ...
    #     batch_size=2,
    #     lr=2e-5,
    #     experiment_name=f"freeze18_maxlength256_lr2e-5_200-stride100_1epochs",
    #     dataset_dir="output/context_pipeline/stage1/exp006.py/20230914064251_multi-qa-mpnet-base-dot-v1_wikiall_without_sep_targetprompt_and_choice_without_sep_token_length200_stride100_all",
    #     freeze_layers=18,
    #     max_length=256,
    #     num_context=1,
    ...
    #     batch_size=2,
    #     lr=2e-5,
    #     experiment_name=f"freeze18_maxlength512_lr2e-5_200-stride100_2contents",
    #     dataset_dir="output/context_pipeline/stage1/exp006.py/20230914064251_multi-qa-mpnet-base-dot-v1_wikiall_without_sep_targetprompt_and_choice_without_sep_token_length200_stride100_all",
    #     freeze_layers=18,
    #     max_length=512,
    #     num_context=2,
    ...
    #     batch_size=2,
    #     lr=2e-5,
    #     experiment_name=f"freeze18_maxlength256_lr2e-5_200-stride100_2epochs",
    #     dataset_dir="output/context_pipeline/stage1/exp006.py/20230914064251_multi-qa-mpnet-base-dot-v1_wikiall_without_sep_targetprompt_and_choice_without_sep_token_length200_stride100_all",
    #     freeze_layers=18,
    #     max_length=256,
    #     num_context=1,
    ...
    #     batch_size=2,
    #     lr=2e-5,
    #     experiment_name=f"freeze18_maxlength256_lr2e-5_200-stride100_2epochs_reinit1layers",
    #     dataset_dir="output/context_pipeline/stage1/exp006.py/20230914064251_multi-qa-mpnet-base-dot-v1_wikiall_without_sep_targetprompt_and_choice_without_sep_token_length200_stride100_all",
    #     freeze_layers=18,
    #     max_length=256,
    #     reinitialize_layers=1,
    #     num_context=1,
    #     steps=250,
    # )
    # main(config=config) 
    ...
    #     batch_size=2,
    #     lr=5e-6,
    #     experiment_name=f"freeze0_maxlength256_lr5e-6_200-stride100_reinit_2layer",
    #     dataset_dir="output/context_pipeline/stage1/exp006.py/20230914064251_multi-qa-mpnet-base-dot-v1_wikiall_without_sep_targetprompt_and_choice_without_sep_token_length200_stride100_all",
    #     freeze_layers=0,
    #     reinitialize_layers=2,
    #     max_length=256,
    ...
    #     batch_size=2,
    #     lr=2e-5,
    #     experiment_name=f"freeze18_maxlength384_lr2e-5_200-stride100",
    #     dataset_dir="output/context_pipeline/stage1/exp006.py/20230914064251_multi-qa-mpnet-base-dot-v1_wikiall_without_sep_targetprompt_and_choice_without_sep_token_length200_stride100_all",
    #     freeze_layers=18,
    #     max_length=384,
    #     num_context=1,
    ...
    # for accumulate in [16, 32, 64]:
    #     config = BertConfig(
    #         debug=False,
    #         epochs=2,
    #         batch_size=2,
    #         lr=5e-6,
    #         experiment_name=f"freeze0_maxlength256_lr5e-6_200-stride100_accumulate_{accumulate}",
    #         dataset_dir="output/context_pipeline/stage1/exp006.py/20230914064251_multi-qa-mpnet-base-dot-v1_wikiall_without_sep_targetprompt_and_choice_without_sep_token_length200_stride100_all",
    #         freeze_layers=0,
    #         iters_to_accumlate=accumulate,
    #         max_length=256,
    #         num_context=1,
    #         steps=250*8//accumulate
    #     )
    #     main(config=config) 
    # config = BertConfig(
    #     debug=False,
    ...
    #     batch_size=2,
    #     lr=5e-6,
    #     experiment_name=f"freeze0_maxlength256_lr5e-6_100-stride75",
    #     dataset_dir="output/context_pipeline/stage1/exp006.py/20230915122742_multi-qa-mpnet-base-dot-v1_wikiall_without_sep_targetprompt_and_choice_without_sep_token_length100_stride75_all",
    #     freeze_layers=0,
    #     max_length=256,
    #     num_context=2,
    # )
    ...
    #     batch_size=2,
    #     lr=5e-6,
    #     experiment_name=f"freeze0_maxlength384_context3_lr5e-6_100-stride75",
    #     dataset_dir="output/context_pipeline/stage1/exp006.py/20230915122742_multi-qa-mpnet-base-dot-v1_wikiall_without_sep_targetprompt_and_choice_without_sep_token_length100_stride75_all",
    #     freeze_layers=0,
    #     max_length=384,
    #     num_context=3,
    ...
    for iters_to_accumulate in [32]:
        config = BertConfig(
            ...
            max_length=256,
            num_context=2,
            steps=250*8//iters_to_accumulate
        )
        main(config=config)