...
def main(config: Config):
    ...
    try:
        ...
        df_test.to_parquet(f"{output_dir}/searched_index_test.parquet")
...
if __name__ == "__main__":        
    ...
    #         pretrain_index_dir="output/context_pipeline/stage1/exp006.py/20230914032500_multi-qa-mpnet-base-dot-v1_wikiall_without_sep_targetprompt_and_choice_without_sep_token_length200_stride100_all",
    ...
    #         extract_file_name=f"output/embeddings/{os.path.basename(model_name)}_{wiki_text_preprocess}_{max_length}_{wiki_file_name}_a_exp004_sep3",
    #         model_name=model_name,
    #         max_length=max_length,
    #         batch_size=128,
    #         wiki_text_preprocess=wiki_text_preprocess,
    ...
    #         wiki_text_preprocess=wiki_text_preprocess,
    #         target_text_preprocess=target_text_preprocess,
    #         pretrain_index_dir="output/context_pipeline/stage1/exp006.py/20230915033046_multi-qa-mpnet-base-dot-v1_wikiall_without_sep_targetprompt_and_choice_without_sep_token_length100_stride75_all",
    #         # target_texts_name=f"data/gpt_generated_data/only_a_250text_2.csv",
    #         target_texts_name=f"data/gpt_generated_data/all_12_with_context2.csv",
    #         feature_extractor="sentence_transformer",
    #     )
    ...
    #         # target_texts_name=f"data/gpt_generated_data/only_a_250text_2.csv",
    #         target_texts_name=f"data/gpt_generated_data/20230914125028_20230911_gpt3.5_generate4.csv",
    #         feature_extractor="sentence_transformer",
    #     )
    #     main(config)
